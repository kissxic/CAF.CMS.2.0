...
namespace CAF.WebSite.Application.WebUI
{
    ...
    public class CoreModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<ArticleCategoryMappingService>().As<IArticleCategoryMappingService>().InstancePerRequest();
            ...
            builder.RegisterType<ArticleExtendedAttributeService>().As<IArticleExtendedAttributeService>().InstancePerRequest();
            ...
            builder.RegisterType<MemberGradeService>().As<IMemberGradeService>().InstancePerRequest();
            builder.RegisterType<MemberGradeMappingService>().As<IMemberGradeMappingService>().InstancePerRequest();

            builder.RegisterType<BannerInfoService>().As<IBannerInfoService>().InstancePerRequest();
            builder.RegisterType<SlideAdInfoService>().As<ISlideAdInfoService>().InstancePerRequest();
            builder.RegisterType<HomeCategoryService>().As<IHomeCategoryService>().InstancePerRequest();
            builder.RegisterType<HomeFloorInfoService>().As<IHomeFloorInfoService>().InstancePerRequest();
            builder.RegisterType<FavoriteInfoService>().As<IFavoriteInfoService>().InstancePerRequest();
            ...
            builder.RegisterType<ImageResizerService>().As<IImageResizerService>().InstancePerRequest();
            builder.RegisterType<SiteMappingService>().As<ISiteMappingService>().InstancePerRequest();
    ...
    public class CachingModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<MemoryCacheManager>().As<ICacheManager>().Named<ICacheManager>("memory").SingleInstance();


            //cache managers
            if (CommonHelper.GetAppSetting<bool>("caf:RedisEnabled", false))
            {

                var connectionString = CommonHelper.GetAppSetting<string>("caf:RedisConnectionString", "");
                if (connectionString.IsEmpty())
                    builder.Register<IContext>(c => new Context()).SingleInstance();
                else
                    builder.Register<IContext>(c => new Context(connectionString)).SingleInstance();
    ...
    public class LocalizationModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<LocalizationService>().As<ILocalizationService>()
                // pass StaticCache as ICache (cache settings between requests)
                .InstancePerRequest();
        ...
        static IComponentRegistration BuildRegistration<TSettings>() where TSettings : ISettings, new()
        {
            return RegistrationBuilder
                .ForDelegate((c, p) =>
                {
                    ...
                    if (c.TryResolve<ISiteContext>(out siteContext))
                    {
                        currentStoreId = siteContext.CurrentSiteIdIfMultiSiteMode;
