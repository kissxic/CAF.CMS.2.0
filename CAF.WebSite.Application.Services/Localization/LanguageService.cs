...
namespace CAF.WebSite.Application.Services.Localization
{
    ...
    public partial class LanguageService : ILanguageService
    {
        ...
        public LanguageService(ICacheManager cacheManager, IRequestCache requestCache,
            IRepository<Language> languageRepository,
          ISiteService storeService,
            ISiteContext storeContext,
            IEventPublisher eventPublisher)
        {
           // this._cacheManager = requestCache;
        ...
        public virtual void UpdateLanguage(Language language)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(LANGUAGES_PATTERN_KEY);
            _cacheManager.RemoveByPattern(ServiceCacheConsumer.SITE_LANGUAGE_MAP_KEY);
