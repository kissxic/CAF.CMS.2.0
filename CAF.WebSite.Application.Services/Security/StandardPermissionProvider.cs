...
namespace CAF.WebSite.Application.Services.Security
{
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageMemberGrades = new PermissionRecord { Name = "会员等级", SystemName = "MemberGrade", Category = "Content MemberGrade" };
        ...
        #region Vendor
        public static readonly PermissionRecord AccessSellerAdminPanel = new PermissionRecord { Name = "商家后台", SystemName = "AccessSellerAdminPanel", Category = "Standard" };
