...
namespace CAF.WebSite.Application.Services.Common
{
    ...
    public partial class MaintenanceService : IMaintenanceService
    {
        ...
        {
            return string.Format("{0}Administrator\\db_backups\\", _httpContext.Request.PhysicalApplicationPath);
        }
        ...
        public virtual void RestoreDatabase(string backupFileName)
        {
            ...
            var conn = new SqlConnectionStringBuilder(DataSettings.Current.DataConnectionString)
            {
