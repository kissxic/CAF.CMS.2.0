...
namespace CAF.WebSite.Application.Services.Users
{
    public static class UserExtentions
    {
        ...
        /// <returns>Result</returns>
        public static bool IsVendor(this User customer, bool onlyActiveCustomerRoles = true)
        {
            return IsInUserRole(customer, SystemUserRoleNames.Vendors, onlyActiveCustomerRoles);
        }
