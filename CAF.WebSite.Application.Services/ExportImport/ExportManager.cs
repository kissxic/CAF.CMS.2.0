    ...
    public partial class ExportManager : IExportManager
    {
        ...
        public virtual void ExportUsersToXlsx(Stream stream, IList<User> users)
        {
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                foreach (var user in users)
                {
                    ...
                    var cityId = user.GetAttribute<int>(SystemUserAttributeNames.CityId);
                    var districtId = user.GetAttribute<int>(SystemUserAttributeNames.DistrictId);
                    ...
                    worksheet.Cells[row, col].Value = cityId;
                    col++;

                    worksheet.Cells[row, col].Value = districtId;
                    col++;
        ...
        public virtual string ExportUsersToXml(IList<User> users)
        {
            ...
            foreach (var user in users)
            {
                ...
                xmlWriter.WriteElementString("CityId", null, user.GetAttribute<int>(SystemUserAttributeNames.CityId).ToString());
                xmlWriter.WriteElementString("DistrictId", null, user.GetAttribute<int>(SystemUserAttributeNames.DistrictId).ToString());
