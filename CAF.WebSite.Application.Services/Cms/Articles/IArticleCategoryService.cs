...
namespace CAF.WebSite.Application.Services.Articles
{
    ...
    public partial interface IArticleCategoryService
    {
        ...
        IList<ArticleCategory> GetAllProductCategoriesByParentCategoryId(int parentCategoryId, bool showHidden = false);

        IList<ArticleCategory> GetAllArticleCategoriesByChannelId(int channelId, bool showHidden = false);
