...
namespace CAF.WebSite.Application.Services.Articles
{
    public static class ArticleAttributeExtentions
    {
        ...
        {
            var genericAttributeService = EngineContext.Current.Resolve<IArticleExtendedAttributeService>();
        ...
        public static TPropType GetArticleAttribute<TPropType>(this BaseEntity entity,
            string key, IArticleExtendedAttributeService genericAttributeService, int siteId = 0)
        {
            if (entity == null)
                throw new ArgumentNullException("entity");

            if (genericAttributeService == null)
                genericAttributeService = EngineContext.Current.Resolve<IArticleExtendedAttributeService>();
        ...
        public static TPropType GetArticleAttribute<TPropType>(this IArticleExtendedAttributeService genericAttributeService, string entityName, int entityId, string key, int siteId = 0)
        {
