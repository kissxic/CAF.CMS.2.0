...
namespace CAF.WebSite.Application.Services.Articles
{
    ...
    public partial interface IArticleService
    {
        ...
        /// <summary>
        /// Getarticle pictures byarticle identifiers
        /// </summary>
        /// <param name="productIds">Product identifiers</param>
        /// <param name="onlyFirstPicture">Whether to only load the first picture for eacharticle</param>
        /// <returns>Product pictures</returns>
        Multimap<int, ArticleAlbum> GetArticlePicturesByArticleIds(int[]articleIds, bool onlyFirstPicture = false);
       ...
       /// <summary>
        ...
        int EnsureMutuallyRelatedArticles(int articleId);
