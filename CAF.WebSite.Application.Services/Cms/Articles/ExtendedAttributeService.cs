...
namespace CAF.WebSite.Application.Services.Articles
{
    ...
    public partial class ExtendedAttributeService : IExtendedAttributeService
    {
        ...
        private const string EXTENDEDATTRIBUTES_CHANNEL_ALL_KEY = "caf.extendedattribute.channel.all-{0}-{1}";
        ...
        public ExtendedAttributeService(IRequestCache requestCache,
        ...
        public virtual void DeleteExtendedAttribute(ExtendedAttribute extendedAttribute)
        {
            ...
            _requestCache.RemoveByPattern(EXTENDEDATTRIBUTES_PATTERN_KEY);
            _requestCache.RemoveByPattern(EXTENDEDATTRIBUTEVALUES_PATTERN_KEY);
        ...
        /// </summary>
        /// <returns>Extended attribute collection</returns>
        public virtual IList<ExtendedAttribute> GetAllExtendedAttributes(int channelId, bool showHidden = false)
        {
            string key = EXTENDEDATTRIBUTES_CHANNEL_ALL_KEY.FormatInvariant(channelId, showHidden);
