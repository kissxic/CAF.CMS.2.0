	...
	public static class FilterExtensions
	{
		...
		public static string ToDescription(this FilterCriteria criteria)
		{
			...
			if (criteria.Operator == FilterOperator.Contains)
				return "{0} {1}".FormatInvariant(localize.GetResource("Articles.Filter.Contains"), value);
			if (criteria.Operator == FilterOperator.StartsWith)
				return "{0} {1}".FormatInvariant(localize.GetResource("Articles.Filter.StartsWith"), value);
			if (criteria.Operator == FilterOperator.EndsWith)
				return "{0} {1}".FormatInvariant(localize.GetResource("Articles.Filter.EndsWith"), value);
		...
		public static string GetUrl(this FilterArticleContext context, FilterCriteria criteriaAdd = null, FilterCriteria criteriaRemove = null)
		{
		...
		public static bool IsActive(this FilterArticleContext context, FilterCriteria criteria)
		{
