...
namespace CAF.WebSite.XLAuth.Controllers
{
    public class ExternalAuthXLController : PluginControllerBase
    {
        private readonly IOAuthProviderXLAuthorizer _oAuthProviderXLAuthorizer;
        private readonly IOpenAuthenticationService _openAuthenticationService;
        private readonly ExternalAuthenticationSettings _externalAuthenticationSettings;
		private readonly ICommonServices _services;

        public ExternalAuthXLController(
            IOAuthProviderXLAuthorizer oAuthProviderXLAuthorizer,
            IOpenAuthenticationService openAuthenticationService,
            ExternalAuthenticationSettings externalAuthenticationSettings,
			ICommonServices services)
        {
            this._oAuthProviderXLAuthorizer = oAuthProviderXLAuthorizer;
        ...
        public ActionResult Configure()
        {
			...
			var settings = _services.Settings.LoadSetting<XLExternalAuthSettings>(storeScope);
		...
		private ActionResult LoginInternal(string returnUrl, bool verifyResponse)
        {
			...
			{
				throw new WorkException("XL module cannot be loaded");
			}

            var viewModel = new LoginModel();
            TryUpdateModel(viewModel);

			var result = _oAuthProviderXLAuthorizer.Authorize(returnUrl, verifyResponse);
