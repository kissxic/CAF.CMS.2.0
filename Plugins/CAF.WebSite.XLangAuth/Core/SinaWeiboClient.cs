...
namespace CAF.WebSite.XLAuth.Core
{
    public class SinaWeiboClient : OpenAuthenticationClientBase
    {
        ...
        public SinaWeiboClient(string appKey, string appSecret, string callbackUrl, string state = null, string accessToken = null, string uid = null)
        ...
        public override string GetAuthorizationUrl()
        {
            ...
            ub.Query = string.Format("client_id={0}&response_type=code&state={1}&redirect_uri={2}&display=Default", ClientId,State, Uri.EscapeDataString(CallbackUrl));
            return ub.ToString();
        }
