...
namespace CAF.WebSite.WeiXinAuth.Controllers
{
    public class ExternalAuthWXController : PluginControllerBase
    {
        private readonly IOAuthProviderWXAuthorizer _oAuthProviderWXAuthorizer;
        private readonly IOpenAuthenticationService _openAuthenticationService;
        private readonly ExternalAuthenticationSettings _externalAuthenticationSettings;
		private readonly ICommonServices _services;

        public ExternalAuthWXController(
            IOAuthProviderWXAuthorizer oAuthProviderWXAuthorizer,
            IOpenAuthenticationService openAuthenticationService,
            ExternalAuthenticationSettings externalAuthenticationSettings,
			ICommonServices services)
        {
            this._oAuthProviderWXAuthorizer = oAuthProviderWXAuthorizer;
        ...
        public ActionResult Configure()
        {
			...
			var settings = _services.Settings.LoadSetting<WXExternalAuthSettings>(storeScope);
		...
		private ActionResult LoginInternal(string returnUrl, bool verifyResponse)
        {
			...
			{
				throw new WorkException("WX module cannot be loaded");
			}

            var viewModel = new LoginModel();
            TryUpdateModel(viewModel);

			var result = _oAuthProviderWXAuthorizer.Authorize(returnUrl, verifyResponse);
