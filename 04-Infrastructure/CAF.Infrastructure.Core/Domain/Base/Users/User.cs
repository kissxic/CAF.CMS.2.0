...
namespace CAF.Infrastructure.Core.Domain.Users
{
    ...
    public partial class User : AuditedBaseEntity, ISoftDeletable
    {
        ...
        private ICollection<FavoriteInfo> _favoriteInfos;
        /// <summary>
        /// Ctor
        /// </summary>
        public User()
        ...
        /// <summary>
        /// Gets or sets the MemberGrade identifier with which this customer is associated (maganer)
        /// </summary>
        ...
        ///  ’≤ÿº–
        /// </summary>
        public virtual ICollection<FavoriteInfo> FavoriteInfos
        {
            get { return _favoriteInfos ?? (_favoriteInfos = new HashSet<FavoriteInfo>()); }
            protected set { _favoriteInfos = value; }
        }
