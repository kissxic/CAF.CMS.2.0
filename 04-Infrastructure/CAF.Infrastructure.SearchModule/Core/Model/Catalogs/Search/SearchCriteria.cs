...
namespace CAF.Infrastructure.SearchModule.Core.Catalogs.Search
{
    public class SearchCriteria
    {
        ...
        public Model.SortInfo[] SortInfos
        {
            get
            {
                return Model.SortInfo.Parse(Sort).ToArray();
            }
        }
       ...
       // public PropertyValue[] PropertyValues { get; set; }
        ...
        {
            Keyword = Keyword.NullEmpty();
            Sort = Sort.NullEmpty();
            CatalogId = CatalogId.NullEmpty();
            CategoryId = CategoryId.NullEmpty();
            Sort = Sort.NullEmpty();
            Sort = Sort.NullEmpty();
