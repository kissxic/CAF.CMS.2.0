...
namespace CAF.WebSite.Mvc.Admin.Infrastructure
{
    public class AutoMapperStartupTask : IStartupTask
    {
        ...
        public void Execute()
        {
            ...
            //sites
            Mapper.CreateMap<MemberGrade, MemberGradeModel>();
            Mapper.CreateMap<MemberGradeModel, MemberGrade>();
            //ModelTemplate
            ...
            Mapper.CreateMap<Channel, ChannelModel>()
                .ForMember(dest => dest.AvailableProductCategorys, mo => mo.Ignore())
            ...
            Mapper.CreateMap<Currency, CurrencyModel>()
                ...
                .ForMember(dest => dest.PrimarySiteCurrencySites, mo => mo.Ignore())
                .ForMember(dest => dest.Locales, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableSites, mo => mo.Ignore())
                .ForMember(dest => dest.SelectedSiteIds, mo => mo.Ignore())
          ...
          .ForMember(dest => dest.Multiple, mo => mo.Ignore());
            ...
            Mapper.CreateMap<ManufacturerModel, Manufacturer>()
                ...
                .ForMember(dest => dest.Picture, mo => mo.Ignore());
            //BannerInfoModel
            Mapper.CreateMap<BannerInfo, BannerInfoModel>();
            Mapper.CreateMap<BannerInfoModel, BannerInfo>();

          
            //SlideAdInfoModel
            Mapper.CreateMap<SlideAdInfo, SlideAdInfoModel>();
            Mapper.CreateMap<SlideAdInfoModel, SlideAdInfo>();

            //HomeCategoryModel
            Mapper.CreateMap<HomeCategory, HomeCategoryModel>();
            Mapper.CreateMap<HomeCategoryModel, HomeCategory>();


            //HomeCategoryItemModel
            Mapper.CreateMap<HomeCategoryItem, HomeCategoryItemModel>();
            Mapper.CreateMap<HomeCategoryItemModel, HomeCategoryItem>();
        }
