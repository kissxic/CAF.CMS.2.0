...
namespace CAF.WebSite.Mvc.Admin.Controllers
{
    ...
    public class SettingController : AdminControllerBase
    {
        ...
        public ActionResult GeneralCommon(GeneralCommonSettingsModel model, FormCollection form)
        {
            ...
            //admin information
            var adminAreaSettings = _settingService.LoadSetting<AdminAreaSettings>(siteScope);
            adminAreaSettings.DisplayArticlePictures = model.AdminAreaSettings.DisplayArticlePictures;
            adminAreaSettings.RichEditorFlavor = model.AdminAreaSettings.RichEditorFlavor;
            adminAreaSettings.GridPageSize = model.AdminAreaSettings.GridPageSize;
            SiteDependingSettings.UpdateSettings(adminAreaSettings, form, siteScope, _settingService);
        ...
        public ActionResult GeneralCommon()
        {
            ...
            //admin information
            var adminAreaSettings = _settingService.LoadSetting<AdminAreaSettings>(siteScope);
            model.AdminAreaSettings.DisplayArticlePictures = adminAreaSettings.DisplayArticlePictures;
            model.AdminAreaSettings.RichEditorFlavor = adminAreaSettings.RichEditorFlavor;
            model.AdminAreaSettings.GridPageSize = adminAreaSettings.GridPageSize;
            SiteDependingSettings.GetOverrideKeys(adminAreaSettings, model.AdminAreaSettings, siteScope, _settingService, false);
        ...
        public ActionResult RewardPoints()
        {
            ...
            var store = (storeScope == 0 ?_siteContext.CurrentSite :  _siteService.GetSiteById(storeScope));

            var model = rewardPointsSettings.ToModel();

            SiteDependingSettings.GetOverrideKeys(rewardPointsSettings, model, storeScope, _settingService);
            ...
            {
                SiteDependingSettings.AddOverrideKey(rewardPointsSettings, "PointsForPurchases_OverrideForStore");
            }
        ...
        public ActionResult RewardPoints(RewardPointsSettingsModel model, FormCollection form)
        {
            ...
            SiteDependingSettings.UpdateSettings(rewardPointsSettings, form, storeScope, _settingService);

            bool pointsForPurchases = SiteDependingSettings.IsOverrideChecked(rewardPointsSettings, "PointsForPurchases", form);
