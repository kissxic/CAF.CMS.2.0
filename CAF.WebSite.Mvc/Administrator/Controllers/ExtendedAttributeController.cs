...
namespace CAF.WebSite.Mvc.Admin.Controllers
{
    ...
    public class ExtendedAttributeController : AdminControllerBase
    {
        ...
        {
            return RedirectToAction("List", new { channelId = channelId });
        }
        ...
        public ActionResult List(int channelId)
        {
            ...
            var channel = this._channelService.GetChannelById(channelId);
            ViewBag.ChannelName = channel.Title;
            return View();
        }

        [HttpPost]
        public ActionResult List(int channelId, DataTablesParam dataTableParam)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageCatalog))
                return AccessDeniedView();

            var extendedAttributes = _extendedAttributeService.GetAllExtendedAttributes(channelId, true);
        ...
        public ActionResult Create(ExtendedAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return continueEditing ? RedirectToAction("Edit", new { id = extendedAttribute.Id }) : RedirectToAction("List",new { channelId =model.ChannelId});
            }
        ...
        public ActionResult Edit(int id)
        {
            ...
            model.ChannelName = extendedAttribute.Channels.Title;
            //locales
        ...
        public ActionResult Edit(ExtendedAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return continueEditing ? RedirectToAction("Edit", extendedAttribute.Id) : RedirectToAction("List", new { channelId = model.ChannelId });
            }
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            return RedirectToAction("List", new { channelId = extendedAttribute.ChannelId });
        }
