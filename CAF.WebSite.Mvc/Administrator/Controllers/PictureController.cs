        ...
        public ActionResult AsyncUpload(bool isTransient = false)
        {
            ...
            return Json(
                new
                {
                    ...
                    imageUrl = _pictureService.GetPictureUrl(picture, 100,100)
                });
        }

        public ActionResult AsyncSmallUpload(bool isTransient = false)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.UploadPictures))
                return Json(new { success = false, error = "You do not have the required permissions" });
            ...
            return base.Content(jsonStr, "text/html");
        }
        /// <summary>
        /// DropZone图片保存
        /// </summary>
