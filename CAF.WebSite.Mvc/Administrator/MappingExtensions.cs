...
using CAF.WebSite.Mvc.Admin.Models.Feedbacks;
...
namespace CAF.WebSite.Mvc.Admin
{
    public static class MappingExtensions
    {
        ...
        {
            return Mapper.Map<ProductCategoryModel, ProductCategory>(model);
        }
        ...
        {
            return Mapper.Map<ProductCategory, ProductCategoryModel>(entity);
        }
        #endregion
        ...
        public static MemberGradeModel ToModel(this MemberGrade entity)
        {
            return Mapper.Map<MemberGrade, MemberGradeModel>(entity);
        }

        public static MemberGrade ToEntity(this MemberGradeModel model)
        {
            return Mapper.Map<MemberGradeModel, MemberGrade>(model);
        }

        public static MemberGrade ToEntity(this MemberGradeModel model, MemberGrade destination)
        {
            return Mapper.Map(model, destination);
        }
        ...
        #region PageSettings
        public static BannerInfoModel ToModel(this BannerInfo entity)
        {
            return Mapper.Map<BannerInfo, BannerInfoModel>(entity);
        }
        public static BannerInfo ToEntity(this BannerInfoModel model)
        {
            return Mapper.Map<BannerInfoModel, BannerInfo>(model);
        }
        public static BannerInfo ToEntity(this BannerInfoModel model, BannerInfo destination)
        {
            return Mapper.Map(model, destination);
        }

        public static SlideAdInfoModel ToModel(this SlideAdInfo entity)
        {
            return Mapper.Map<SlideAdInfo, SlideAdInfoModel>(entity);
        }
        public static SlideAdInfo ToEntity(this SlideAdInfoModel model)
        {
            return Mapper.Map<SlideAdInfoModel, SlideAdInfo>(model);
        }
        public static SlideAdInfo ToEntity(this SlideAdInfoModel model, SlideAdInfo destination)
        {
            return Mapper.Map(model, destination);
        }
        ...
        //HomeCategoryModel
        public static HomeCategoryModel ToModel(this HomeCategory entity)
        {
            return Mapper.Map<HomeCategory, HomeCategoryModel>(entity);
        }

        public static HomeCategory ToEntity(this HomeCategoryModel model)
        {
            return Mapper.Map<HomeCategoryModel, HomeCategory>(model);
        }

        public static HomeCategory ToEntity(this HomeCategoryModel model, HomeCategory destination)
        {
            return Mapper.Map(model, destination);
        }

        //HomeCategory Item
        public static HomeCategoryItemModel ToModel(this HomeCategoryItem entity)
        {
            return Mapper.Map<HomeCategoryItem, HomeCategoryItemModel>(entity);
        }

        public static HomeCategoryItem ToEntity(this HomeCategoryItemModel model)
        {
            return Mapper.Map<HomeCategoryItemModel, HomeCategoryItem>(model);
        }

        public static HomeCategoryItem ToEntity(this HomeCategoryItemModel model, HomeCategoryItem destination)
        {
            return Mapper.Map(model, destination);
        }
        #endregion
