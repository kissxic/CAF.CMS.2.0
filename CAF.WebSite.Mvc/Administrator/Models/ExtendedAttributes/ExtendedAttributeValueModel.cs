...
namespace CAF.WebSite.Mvc.Admin.Models.ExtendedAttributes
{
    ...
    public class ExtendedAttributeValueModel : EntityModelBase, ILocalizedModel<ExtendedAttributeValueLocalizedModel>
    {
        ...
        [LangResourceDisplayName("Admin.ContentManagement.Attributes.ExtendedAttributes.Values.Fields.Name")]
        [AllowHtml]
        public string Name { get; set; }

        [LangResourceDisplayName("Admin.ContentManagement.Attributes.ExtendedAttributes.Values.Fields.IsPreSelected")]
        public bool IsPreSelected { get; set; }

        [LangResourceDisplayName("Admin.ContentManagement.Attributes.ExtendedAttributes.Values.Fields.DisplayOrder")]
