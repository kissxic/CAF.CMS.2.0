...
namespace CAF.WebSite.Mvc.Admin.Models.Sites
{
    ...
    public partial class SiteModel : EntityModelBase
	{
        ...
        [LangResourceDisplayName("Admin.Configuration.Sites.Fields.PrimaryStoreCurrencyId")]
        public int PrimarySiteCurrencyId { get; set; }
        [LangResourceDisplayName("Admin.Configuration.Stores.Fields.PrimaryStoreCurrencyId")]
        public string PrimarySiteCurrencyName
        {
            get
            {
                try
                {
                    return AvailableCurrencies.First(x => x.Value == PrimarySiteCurrencyId.ToString()).Text;
                }
                catch { }
