...
namespace CAF.WebSite.Mvc.Admin.Models.Settings
{
    ...
    public partial class GeneralCommonSettingsModel : ModelBase
    {
        ...
        public partial class AdminAreaSettingsModel
        {
            [LangResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.AdminAreaSettings.GridPageSize","页数")]
            public int GridPageSize { get; set; }

            [LangResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.AdminAreaSettings.DisplayArticlePictures","显示文档图片")]
            public bool DisplayArticlePictures { get; set; }

            [LangResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.AdminAreaSettings.RichEditorFlavor", "编辑器名称")]
