...
namespace CAF.WebSite.Mvc.Admin.Models.Articles
{
    ...
    public partial class ArticleCategoryModel : TabbableModel, ILocalizedModel<ArticleCategoryLocalizedModel>
    {
        public ArticleCategoryModel()
        {
            ...
            ArticleCategorySpecificationAttributeModel = new List<ArticleCategorySpecificationAttributeModel>();
        ...
        ///频道图标
        /// </summary>
        [LangResourceDisplayName("Admin.ContentManagement.ArticleCategory.Fields.IconName", "图标名称")]
        ...
        [LangResourceDisplayName("Admin.Catalog.Categories.Fields.PriceRanges","价格范围")]
        [AllowHtml]
        ...
        public IList<ArticleCategorySpecificationAttributeModel> ArticleCategorySpecificationAttributeModel { get; set; }
        /// <summary>
        /// 内容属性字符串
        /// </summary>
