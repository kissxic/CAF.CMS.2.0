...
namespace CAF.WebSite.Mvc.Admin.Models.Articles
{
    public partial class ArticleListModel : ModelBase
    {
        ...
        [LangResourceDisplayName("Admin.ContentManagement.Articles.List.SearchChannelId","频道")]
        public int SearchChannelId { get; set; }

        [LangResourceDisplayName("Admin.ContentManagement.Articles.List.SearchProductCategoryId")]
