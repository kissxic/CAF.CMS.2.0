...
namespace CAF.WebSite.Mvc.Admin.Models.Users
{
    ...
    public class UserModel : TabbableModel
    {
        public UserModel()
        {
            ...
            AvailableMemberGrades = new List<SelectListItem>();
        }
        ...
        [LangResourceDisplayName("Admin.Users.Users.Fields.District")]
        [AllowHtml]
        ...
        [LangResourceDisplayName("Admin.Users.Users.Fields.VendorId","商家")]
        public int VendorId { get; set; }
        public IList<SelectListItem> AvailableVendors { get; set; }
        [LangResourceDisplayName("Admin.Users.Users.Fields.MemberGradeId","会员等级")]
        public int MemberGradeId { get; set; }
        public IList<SelectListItem> AvailableMemberGrades { get; set; }
