...
namespace CAF.WebSite.Mvc.Infrastructure
{
    public partial class CmsRoutes : IRouteProvider
    {
        ...
        ----------------------------------------*/
            ...
            //分类频道
            routes.MapLocalizedRoute("AllCategory",
            "list-{channelId}",
            new { controller = "ArticleCatalog", action = "AllCategory" },
            new { channelId = idConstraint },
            new[] { "CAF.WebSite.Mvc.Controllers" });

            //商品频道-栏目
            routes.MapLocalizedRoute("ProductCategory",
            "list-{channelId}-{categoryId}",
            new { controller = "ProductCategory", action = "ProductCategory" },
            new { channelId = idConstraint, categoryId = idConstraint, },
            new[] { "CAF.WebSite.Mvc.Controllers" });
