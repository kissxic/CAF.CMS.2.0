    ...
    define(['jquery', 'Q'], function ($, q) {
        ...
        function _getFooter(buttons) {
            ...
            if (buttons) {
                ...
                messageFotter.append('<button class="x btn btn-primary"  type=button>确认</button>');
                messageFotter.append('<button class="x btn " data-dismiss=modal type=button>关闭</button>');
            }
        ...
        function _getModalInstance(params,getIfExists) {
            /// <summary>
            ...
            function createModalElement() {
                ...
                return $('<div  id="' + params.modalId + '" class="modal fade" tabindex="-1"><style>.modal-xl{width:96%;}</style>'
        ...
        function _setup(params, title) {
            ...
            // Lazy loading
            var $ref = _getModalInstance(params);
